// Generated on 2016-05-05 using generator-ionic 0.8.0
'use strict';
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      html: {
        ...
        tasks: ['newer:html2js:main', 'newer:copy:app']
      },
      js: {
      ...
      sass: {
          ...
          tasks: [ 'newer:copy:styles', 'sass', 'newer:copy:tmp']
      },
	styles: {
    ...
    jshint: {
      options: {
        ...
        ignores: [
          ...
          '<%= yeoman.app %>/<%= yeoman.scripts %>/controllers/cameractrl.js'
        ]
      },
      all: [
        'Gruntfile.js',
    ...
    sass: {
	    dist: {
	      ...
	      files: { // destination : source
	         '<%= yeoman.app %>/<%= yeoman.styles %>/main.css':'<%= yeoman.app %>/<%= yeoman.styles %>/main.scss',
	         '<%= yeoman.app %>/<%= yeoman.styles %>/rascal.css':'<%= yeoman.app %>/<%= yeoman.styles %>/rascal.scss'
	      }
	    }
    },
    ...
    karma: {
      options: {
        ...
        files: [
          ...
          '<%= yeoman.app %>/bower_components/angular-idle-service/dist/angular-idle-service.js',
    ...
    html2js: {
      options: {
        module: 'rascal.templates',
        base: '<%= yeoman.app %>'
      },
      main: {
        src: ['<%= yeoman.app %>/templates/*.html'],
        dest: '<%= yeoman.app %>/<%= yeoman.scripts %>/templates.js'
      }
    }

  });

  //why aren't any of the other packages loaded? Is this the only one that needs it?
